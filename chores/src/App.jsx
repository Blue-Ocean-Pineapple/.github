    ...
    <AuthContextProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/profile"
            element={<Profile role={role} setRole={setRole} roles={roles} />}
          />
          <Route
            path="/admin"
            element={isAuth && role === "Admin" ? <Admin /> : <Login />}
          />
          <Route
            path="/customer"
            element={isAuth && role === "Client" ? <Customer /> : <Login />}
          />
          <Route
            path="/staff"
            element={isAuth && role === "Staff" ? <Staff /> : <Login />}
          />
          <Route
            path="/student"
            element={isAuth && role === "Student" ? <Student /> : <Login />}
          />
